...
export default function ServicePage() {
  return (
    <LegalPage eyebrow="SERVICE & PRICING" title="服务内容与计费说明">
      <section>
        <h2>一、服务是什么</h2>
        <p>“二”提供自我探索与数字内容服务，包括 AI 对话、荣格认知功能测试、八字排盘、六爻记录与相关文化内容。部分基础功能免费，调用 AI 生成内容的功能会消耗站内铜币。</p>
      ...
      <section>
        ...
        <p>实际消耗会在用户发起服务前于页面显示；如后续调整计费，将提前更新本说明，不追溯影响已完成的消费。</p>
      </section>
      <section>
        <h2>三、铜币服务包</h2>
        <ul>
        ...
        <p>铜币仅限当前账户在本网站使用，不可转赠、交易、提现或兑换现金。支付成功后由支付宝异步通知本网站，系统直接向当前账户增加铜币。</p>
      </section>
      <section>
        <h2>四、交付与查询</h2>
        <p>通常在支付宝确认支付成功后即时到账。因网络延迟暂未到账时，请保留支付宝交易号并通过客服邮箱联系我们。你可以在网站右上角或个人设置中查看当前铜币余额。</p>
