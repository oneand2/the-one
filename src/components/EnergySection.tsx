  ...
  return (
    ...
    >
      <div className="bg-[#FAF8F5] rounded-2xl overflow-hidden shadow-sm">
        {/* 标题区 */}
        <div className="bg-gradient-to-r from-stone-50 to-stone-100/50 px-8 py-6 border-b border-stone-200">
          <h2 className="text-2xl font-serif text-[#4A403A] tracking-wider text-center mb-3">
            五行流通 · 能量分布
          </h2>
        ...
        <div className="px-8 py-10">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            {/* 左侧：天干能量（细化） */}
            <div>
              <h3 className="text-base font-serif text-[#8B5F45] mb-6 text-center tracking-wider">
                天干能量
              </h3>
              <div className="space-y-4">
                {activeGans.map((gan) => (
                  ...
                  >
                    {/* 标签 */}
                    <span
                      className="text-sm font-serif tracking-wider w-8 text-right"
                    ...
                    {/* 能量值 */}
                    <span className="text-xs font-sans text-stone-400 w-12 text-right">
                ...
                {activeShishen.map((ss) => {
                  ...
                  return (
                    ...
                    >
                      {/* 标签 */}
                      <span
                        className={`text-sm font-serif tracking-wider w-12 text-right ${
                          isMax ? 'font-bold' : ''
                        }`}
        ...
        <div className="px-8 pb-8 space-y-4">
          {/* 格局与用神 */}
          <div className="bg-stone-50/50 rounded-xl px-6 py-5 border border-stone-200/50">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {/* 格局判定 */}
              <div className="text-center">
                <div className="text-sm font-sans text-stone-500 mb-1">格局判定</div>
                <div className="text-lg font-serif text-[#8B5F45] font-bold tracking-wide">
              ...
              {/* 用神判定 */}
              <div className="text-center">
                <div className="text-sm font-sans text-stone-500 mb-1">用神</div>
                <div className="text-base font-serif text-[#B09F73] font-bold tracking-wide">
          ...
          <div className="bg-stone-50/50 rounded-xl px-6 py-5 border border-stone-200/50">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {/* 燥湿程度 */}
              <div className="text-center">
                <div className="text-sm font-sans text-stone-500 mb-1">燥湿程度</div>
              ...
              {/* 调候用神 */}
              <div className="text-center">
                <div className="text-sm font-sans text-stone-500 mb-1">调候用神</div>
                <div
                  className="text-base font-serif tracking-wide font-bold"
                  style={{
              ...
              {/* 扶抑用神 */}
              <div className="text-center">
                <div className="text-sm font-sans text-stone-500 mb-1">扶抑用神</div>
                <div
                  className="text-base font-serif tracking-wide font-bold"
                  style={{
