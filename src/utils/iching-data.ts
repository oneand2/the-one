...
export const ICHING_64_HEXAGRAMS: Hexagram[] = [
  {
    code: "111111",
    name: "乾",
    title: "乾为天",
 ...
 * 根据二进制代码查找卦象
 */
export function findHexagramByCode(code: string): Hexagram | undefined {
  return ICHING_64_HEXAGRAMS.find(hex => hex.code === code);
}
